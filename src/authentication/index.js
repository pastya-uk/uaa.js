...
function Authentication(options) {
  ...
  this.baseOptions.rootUrl = this.baseOptions.prefix + this.baseOptions.domain;
 ...
 * @param {Object} options: link to the documentation for this api
 * @param {Function} cb
 */
Authentication.prototype.buildAuthorizeUrl = function (options) {
  ...
  if (this.baseOptions._sendTelemetry) {
    params.uaaClient = this.request.getTelemetryData();
  }
  ...
  params = objectHelper.toSnakeCase(params, ['uaaClient']);
 ...
 * @param {Object} options: url to logout documentation
 */
Authentication.prototype.buildLogoutUrl = function (options) {
  ...
  params = objectHelper.toSnakeCase(params, ['uaaClient', 'returnTo']);
...
Authentication.prototype.login = function (options, cb) {
  ...
  options.grantType = 'password-realm';
...
Authentication.prototype.oauthToken = function (options, cb) {
  ...
  body = objectHelper.toSnakeCase(body, ['uaaClient']);
